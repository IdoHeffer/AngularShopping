...
@Component({
  selector: 'app-winesandbeers',
  templateUrl: './winesandbeers.component.html',
  styleUrls: ['./winesandbeers.component.css']
})
export class WinesandbeersComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let observable = this.productsService.getAllCategoriesProducts(8);
